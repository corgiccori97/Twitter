...
export default function Nav() {
    return (
        ...
        <nav className='flex flex-col space-y-5 px-2 items-center'>
            ...
            <svg
            className='w-8 h-8 cursor-pointer fill-black' 
            ...
            className='w-8 h-8 cursor-pointer'
            fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
            <svg 
            className='w-12 h-12 cursor-pointer bg-[#3BA9EE] text-white p-2 rounded-full'
            fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
